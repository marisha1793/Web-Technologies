...
1.js (его тоже необходимо создать рядом с html-файлом). В js-файле необходимо создать 
следующий скрипт:
...
let t_celsius = parseInt(prompt('Введите температуру в градусах Цельсия'))
alert(`Цельсий: ${t_celsius}, Фаренгейт: ${parseInt((9/5)*t_celsius+32)}`)